...
common_isr: 
    ...
    push eax ; (ax is the lower 16 bits of eax)
    mov ax, 0x10 ; move the kernel datasegment
    mov ds, ax
    mov es, ax
    mov fs, ax
    ...
    mov es, ax
    mov fs, ax
    mov gs, ax ; don't change the stack
    popad
    add esp, 8 ; add back for the int code and exn num
    iretd ; return to the caller

;declare a macro to create assembly stubs for our exception / interrupt handlers
